...
fun AddYogaClass(courseId: Int) {
    ...
    var showErrorWrongDayOfWeek by remember { mutableStateOf(false) }
    ...
    fun onAdd() {
        ...
        yogaCourseDao.insertYogaClass(newYogaClass)
        ...
        AlertDialog(onDismissRequest = { showSuccessAlert = false },
            title = {
                Text(
                    ...
                    text = "Add new yoga class successfully"
                )
            },
            text = { Text(text = "A new class has been added into the system") },
