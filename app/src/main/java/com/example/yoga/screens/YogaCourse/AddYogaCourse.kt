...
fun AddYogaCourse() {
    ...
    val selectedTime = rememberTimePickerState(LocalDateTime.now().hour, LocalDateTime.now().minute)
    ...
    fun onAdd() {
        ...
        yogaCourseDao.insert(newYogaCourse)
        ...
        AlertDialog(onDismissRequest = { showSuccessAlert = false },
            title = {
                Text(
                    ...
                    text = "Add new yoga course successfully"
                )
            },
            text = { Text(text = "A new course has been added into the system") },
